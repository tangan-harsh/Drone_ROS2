...
bool heart_motor(const std::shared_ptr<base_lidar::srv::Control::Request> req, std::shared_ptr<base_lidar::srv::Control::Response> res)
{
    UNUSED(res);
...
int main(int argc, char **argv)
{
    ...
    rclcpp::Service<base_lidar::srv::Control>::SharedPtr service = node->create_service<base_lidar::srv::Control>("/heart_motor", heart_motor);
