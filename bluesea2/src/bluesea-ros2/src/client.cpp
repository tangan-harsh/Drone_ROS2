...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<base_lidar::srv::Control>::SharedPtr client = node->create_client<base_lidar::srv::Control>(serviceName);  // CHANGE
  //Retain four universal parameters
  auto request = std::make_shared<base_lidar::srv::Control::Request>(); 
